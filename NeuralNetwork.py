...
def main():
    ...
    dimension_100 = NeuralNetwork(save_weights=True, epochs=250,
                                 hidden_size=[400], hidden_amount=1, output_size=output_size, class_type=class_type, loss=loss, save_space=True, save_architecture=True, file_name="All-Layer-400-L")
    ...
    dimension_100 = NeuralNetwork(save_weights=True, epochs=250,
                                 hidden_size=[400], hidden_amount=1, output_size=output_size, class_type=class_type, loss=loss, save_space=True, save_architecture=True, file_name="Genres-Layer-400-L")
    ...
    dimension_100 = NeuralNetwork(save_weights=True, epochs=250,
                                 hidden_size=[400], hidden_amount=1, output_size=output_size, class_type=class_type, loss=loss, save_space=True, save_architecture=True, file_name="Keywords-Layer-400-L")
